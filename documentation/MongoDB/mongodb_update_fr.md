...
Vérification. Doit retourner { "featureCompatibilityVersion" : "6.0" }

db.adminCommand( { setFeatureCompatibilityVersion: "6.0" } )

Correction. Force la compatibilité 6.0 si nécessaire.
...
Mise à jour des paquets (OS level) :

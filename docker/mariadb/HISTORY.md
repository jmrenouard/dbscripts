* [2026-01-09] Added `make inject-employee` and `make inject-sakila` commands to automate full Galera deployment and sample data injection from github.com/jmrenouard/test_db.
